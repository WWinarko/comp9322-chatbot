...
validators = {
    ('ask', 'GET'): {'args': {'required': ['expression'], 'properties': {'expression': {'description': 'user sentence e.g. how is the weather in Sydney', 'type': 'string'}}}},
}

filters = {
    ('ask', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'type': {'type': 'string'}, 'answer': {'type': 'string'}}}}},
}
